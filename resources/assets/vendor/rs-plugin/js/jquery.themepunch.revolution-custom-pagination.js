		...
		********************************/
		...
		var createBullets = function(container,opt) {
			...
			if (opt.navigationType=="bullet"  || opt.navigationType=="both") {
						container.parent().append('<div class="container container-relative clearfix"><div class="tp-bullets '+starthidebullets+' simplebullets '+opt.navigationStyle+'"></div></div>');
			}
			...
			container.find('>ul:first >li').each(function(i) {
							...
							bullets.append('<div class="bullet"><span></span></div>');
