@php
    seo_helper()->setTitle(trans('core::core.error 404'));
    Breadcrumbs::register('404', function($breadcrumbs){
        $breadcrumbs->push(trans('core::core.error 404'));
    });
@endphp
...
@section('content')
    ...
    @component('partials.components.breadcrumbs', ['header_type'=>1, 'breadcrumb'=>'404'])
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 m-top-10">
                    <h3>{{ trans('core::core.error 404').' : '.trans('core::core.error 404 title') }}</h3>
                    <p>{{ trans('themes::page.message.404') }}</p>
