<form id="form3" class="form-horizontal" name="form1" method="post">
    ...
    <div class="control-group">
        <div class="controls">
            <button type="button" onclick="htipi_calc('#form3');" class="button small deeporange"
    ...
    <div class="control-group">
        <label class="control-label" for="inputEmail">2,0 M Dikey Eleman</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label" for="inputEmail">Yatay Bağlantı</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label" for="inputEmail">Capraz Bağlantı</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label" for="inputEmail">2.5 M Kalas</label>
        <div class="controls">
