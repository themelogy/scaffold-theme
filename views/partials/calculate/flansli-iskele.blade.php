<form id="form2" class="form-horizontal" name="form1" method="post">
    <div class="control-group">
        <label class="control-label" for="inputEmail">Yükseklik</label>
        <div class="controls">
            <div class="input-append">
                <input type="text" name="yukseklik" id="yukseklik" value="0" class="form-control span2"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <div class="input-append">
                <input type="text" name="genislik" id="genislik" value="0" class="form-control span2"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <div class="input-append">
                <input type="text" name="cephe" id="cephe" value="1" class="form-control span2" placeholder="Cephe"/>
    ...
    <div class="control-group">
        <div class="controls">
            <button type="button" onclick="flans_hesapla('#form2');"
                    class="button small deeporange" style="margin-right: 2px;">Hesapla
            </button>
    ...
    <div class="control-group">
        <label class="control-label" for="inputEmail">3,0 M Dikey Eleman</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label" for="inputEmail">3,0 M Yatay Eleman</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label" for="inputEmail">0.70 M Yatay Eleman</label>
        <div class="controls">
    ...
    <div class="control-group">
        <label class="control-label" for="inputEmail">3 M Kalas</label>
        <div class="controls">
